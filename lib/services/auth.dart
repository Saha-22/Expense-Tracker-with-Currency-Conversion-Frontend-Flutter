...
class AuthService {
  static Future<UserModel> create(
    ...
    userModel.emailVerifiedAt = user['email_verified_at'] != null
        ? DateTime.parse(user['email_verified_at'])
        : null;
  ...
  static Future<UserModel> update(Map<String, dynamic> user) async {
    ...
    userModel.createdAt = user['created_at'] != null
        ? DateTime.parse(user['created_at'])
        : userModel.createdAt;
    userModel.updatedAt = user['updated_at'] != null
